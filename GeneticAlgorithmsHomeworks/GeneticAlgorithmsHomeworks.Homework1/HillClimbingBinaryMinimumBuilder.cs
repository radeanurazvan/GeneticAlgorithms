...
{
    public class HillClimbingBinaryMinimumBuilder
    {
        ...
        public HillClimbingBinaryMinimumBuilder WithFunction(DimensionalFunction function)
        {
        ...
        public HillClimbingBinaryMinimumBuilder WithImprovementStrategy(ImprovementStrategy strategy)
        {
        ...
        public HillClimbingBinaryMinimumBuilder WithIterations(int iterations)
        {
            if (iterations <= 0)
            {
